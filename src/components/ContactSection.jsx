...
<section className="section-contact">
        <div id="contact" className="contact">
          <div className="contact__heading-box reveal-box reveal">
            ...
            <p className="contact__subheading">Napíš mi</p>
          </div>

          <div className="contact__adress reveal-box reveal">
            <h3 className="heading-tertiary contact__heading-tertiary--1">
              Moja adresa
            </h3>
            ...
            <div className="contact__contact-box contact__contact-box--1">
              ...
              <div className="contact__adress-box">
                ...
                <p className="contact__text">Dlhé Hony 3251/66</p>
            ...
            <h3 className="heading-tertiary contact__heading-tertiary--2">
              Sleduj ma
            </h3>
            <div className="contact__contact-box">
              <a
                href="#"
                className="contact__icon-follow contact__icon-follow--facebook"
              >
                <i className="ph-facebook-logo"></i>
              </a>
              <a
                href="#"
                className="contact__icon-follow contact__icon-follow--twitter"
              >
                <i className="ph-twitter-logo"></i>
              </a>
              <a
                href="#"
                className="contact__icon-follow contact__icon-follow--instagram"
              >
                <i className="ph-instagram-logo"></i>
              </a>
              <a
                href="#"
                className="contact__icon-follow contact__icon-follow--linkedin"
              >
                <i className="ph-linkedin-logo"></i>
              </a>
              <a
                href="#"
                className="contact__icon-follow contact__icon-follow--pinterest"
              >
          ...
          <div className="contact__form reveal-box reveal">
            <div className="contact__form-box">
              <h2 className="heading-secondary">Napiš mi</h2>
              <form
                className="form"
                action="https://formsubmit.co/bryan.richard.portfolio@gmail.com"
                method="POST"
              >
                <div className="form__group form__group--1">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="name" className="form__label">Celé meno</label>
                </div>
                ...
                <div className="form__group form__group--4">
                  <button type="submit" className="btn btn--white btn__mail">
                    Napíš mi &rarr;
                  </button>
                </div>
              </form>
